...
- **[Nome funzione/classe]**: Descrivi in dettaglio lo scopo della funzione o classe, elencando i principali parametri e il loro significato, oltre al tipo di ritorno. 
Se applicabile, illustra anche eventuali eccezioni gestite. Esplora il flusso logico interno della funzione/classe, evidenziando i passaggi principali.
...
- **Codice pulito**: Verifica la chiarezza e la leggibilità.
- **Gestione degli errori**: Esamina la robustezza della gestione degli errori.
...
Valuta:
- **Copertura dei test**: L'adeguatezza dei test presenti.
...
1. **Analisi dell'architettura attuale:**
   ...
   - Metti in evidenza i punti deboli e i limiti dell'architettura attuale.
   - Identifica eventuali problematiche ricorrenti nell'implementazione o nella gestione del codice.
...
2. **Proposta di nuova architettura:**
   ...
   - Illustra i pattern architetturali che proponi e il loro impatto positivo.
...
3. **Impatto sulla migrazione:**
   ...
   - Definisci le fasi principali del processo di migrazione.
   - Indica i potenziali rischi associati alla migrazione e come mitigarli.

4. **Valutazione e metriche:**
   - Suggerisci metriche chiave per misurare l'efficacia della nuova architettura rispetto a quella attuale.
...
5. **Best Practices e raccomandazioni:**
   ...
   - Sottolinea eventuali decisioni tecniche che dovrebbero essere prese con attenzione.
